...
HD_PWD='C:/Users/Public/Xilinx_Vivado_Vitis/simple_logic_gate/simple_logic_gate.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log logic_gate_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source logic_gate_top.tcl -notrace
