...
HD_PWD='C:/Users/Public/Xilinx_Vivado_Vitis/simple_logic_gate/simple_logic_gate.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log logic_gate_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source logic_gate_top.tcl
