...
HD_PWD='C:/Users/Public/Xilinx_Vivado_Vitis/flip_flop_demo/flip_flop_demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log flip_flop_demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source flip_flop_demo.tcl -notrace
