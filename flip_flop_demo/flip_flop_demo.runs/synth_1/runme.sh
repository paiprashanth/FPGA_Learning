...
HD_PWD='C:/Users/Public/Xilinx_Vivado_Vitis/flip_flop_demo/flip_flop_demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flip_flop_demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flip_flop_demo.tcl
